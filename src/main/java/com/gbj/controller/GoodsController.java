...
public class GoodsController {
	...
	@ResponseBody
	public JacksonData goodsTypeDel(@RequestParam Integer id) {
		JacksonData backData = new JacksonData();
		GoodsType goodsType = goodsTypeService.goodsTypeDelAction(id);
		backData.success(goodsType);
		return backData;
	}
	...
	//通过ID删除该类型的信息，，，物理删除
	@RequestMapping("/goodsUnitDel")
	@ResponseBody
	public JacksonData goodsUnitDel(@RequestParam Integer id) {
		JacksonData backData = new JacksonData();
		GoodsUnit goodsUnit = goodsUnitService.goodsUnitDelAction(id);
		backData.success(goodsUnit);
		return backData;
	}
