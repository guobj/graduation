...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <form target="_self" method="post" action="supplierAdd.action" class="form-horizontal m-t" id="signupForm" enctype="multipart/form-data" onsubmit="return confirmInfo()">
            <div class="col-sm-6">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="sup_name" name="sup_name" class="form-control" type="text">
                                        <font id="c_name"></font>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="sup_tel" name="sup_tel" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                         <font id="c_tel"></font>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="sup_bank" name="sup_bank" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                        <font id="s_bank"></font>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="sup_bank_id" name="sup_bank_id" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                                    ...
                                    <div class="col-sm-8">
                                        <select data-placeholder="选择经济类型..." id="fk_et_id" name="fk_et_id" class="form-control" tabindex="2">
                                            ...
                                            <c:forEach items="${economicTypeList }" var="economicType">
                                                <option value="${economicType.et_id }">${economicType.et_type }</option>
                                            </c:forEach>
                                        </select>
                                        <font id="et_id"></font>
                                    </div>
                                ...
                                <div class="col-sm-8">
                                     <select data-placeholder="选择客户等级..." id="fk_cg_id" name="fk_cg_id" class="form-control" tabindex="2">
                                        ...
                                        <c:forEach items="${consumerGrandList }" var="consumerGrand">
                                            <option value="${consumerGrand.cg_id }">${consumerGrand.cg_name }</option>
                                        </c:forEach>
                                    </select>
                                    <font id="cg_id"></font>
                                </div>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="sup_scope" name="sup_scope" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
