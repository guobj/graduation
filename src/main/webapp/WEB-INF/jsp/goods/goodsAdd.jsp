                    ...
                    <div class="ibox-content" style="overflow: scroll;height: 500px;">
                        <form target="_self" action="goodsAddAction" method="post" class="form-horizontal m-t" id="signupForm" enctype="multipart/form-data" onsubmit="return confirmInfo()">
                                ...
                                <div class="col-sm-8">
                                    <select data-placeholder="选择省份..." id="fk_gt_id" name="fk_gt_id" class="form-control" tabindex="2">
                                        ...
                                        <c:forEach items="${typeList }" var="type">
                                            <option value="${type.gt_id }">${type.gt_type }</option>
                                        </c:forEach>
                                    </select>
                                     <font id="t_name"></font>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="goods_price" name="goods_price" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                     <font id="p_name"></font>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="goods_vipprice" name="goods_vipprice" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                ...
                                <div class="col-sm-8">
                                     <select data-placeholder="选择省份..." id="fk_gu_id" name="fk_gu_id" class="form-control" tabindex="2">
                                        ...
                                        <c:forEach items="${unitList }" var="unit">
                                            <option value="${unit.gu_id }">${unit.gu_name }</option>
                                        </c:forEach>
                                    </select>
                                    <font id="u_name"></font>
                                </div>
