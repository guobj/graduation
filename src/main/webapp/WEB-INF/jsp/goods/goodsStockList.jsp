                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <div class="ibox-tools">
                            <form action="goodsStock" method="post" target="_self">
...
<!--                                     <th>操作</th> -->
                            ...
                            <c:forEach items="${goodsStockList }" var="goodsStock">
                                <tr>
                                    ...
                                    <td>${goodsStock.gtype.gt_type }</td>
                                    <td>${goodsStock.goods_nums }</td>
<!--                                     <td> -->
<%--                                         <button type="button" class="btn btn-outline btn-danger" onclick="del(${goodsStock.goods_id })">删除</button> --%>
<!--                                     </td> -->
