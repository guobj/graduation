            ...
            <div class="col-sm-6">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form target="_self" method="post" action="goodsUnitAdd.action" class="form-horizontal m-t" id="signupForm" enctype="multipart/form-data" onsubmit="return confirmInfo()">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">商品单位：</label>
                                <div class="col-sm-8">
                                    <input id="gu_name" name="gu_name" class="form-control" type="text">
                                    <font id="g_name"></font>
                                </div>
                            </div>
