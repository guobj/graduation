                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="con_name" name="con_name" class="form-control" type="text">
                                        <font id="c_name"></font>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="con_tel" name="con_tel" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                         <font id="c_tel"></font>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="con_email" name="con_email" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                    ...
                                    <div class="col-sm-8">
                                         <select data-placeholder="选择隶属行业..." id="fk_in_id" name="fk_in_id" class="form-control" tabindex="2">
                                            ...
                                            <c:forEach items="${industryList }" var="industry">
                                                <option value="${industry.in_id }">${industry.in_name }</option>
                                            </c:forEach>
                                        </select>
                                        <font id="in_id"></font>
                                    </div>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="con_price" name="con_price" class="form-control" type="text">
                                ...
                                <div class="col-sm-8">
                                    <select data-placeholder="选择销售模式..." id="fk_sm_id" name="fk_sm_id" class="form-control" tabindex="2">
                                        ...
                                        <c:forEach items="${saleModelList }" var="saleModel">
                                            <option value="${saleModel.sm_id }">${saleModel.sm_name }</option>
                                        </c:forEach>
                                    </select>
                                     <font id="sm_id"></font>
                                </div>
                                ...
                                <div class="col-sm-8">
                                    <select data-placeholder="选择客户来源..." id="fk_cs_id" name="fk_cs_id" class="form-control" tabindex="2">
                                        ...
                                        <c:forEach items="${consumerSourceList }" var="consumerSource">
                                            <option value="${consumerSource.cs_id }">${consumerSource.cs_name }</option>
                                        </c:forEach>
                                    </select>
                                    <font id="cs_id"></font>
                                </div>
