            ...
            <div class="col-sm-6">
                <div class="ibox float-e-margins">
                    <div class="ibox-content">
                        <form target="_self" method="post" action="consumerGrandAdd.action" class="form-horizontal m-t" id="signupForm" enctype="multipart/form-data" onsubmit="return confirmInfo()">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">等级名称：</label>
                                <div class="col-sm-8">
                                    <input id="cg_name" name="cg_name" class="form-control" type="text">
                                    <font id="c_name"></font>
                                </div>
                            </div>
