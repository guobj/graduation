            ...
            <!-- <div class="col-sm-6"> -->
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><button style="width: 50px" type="button" class="btn btn-outline btn-info" onclick="consumerGrandAdd()">添加</button></h5>
                        <div class="ibox-tools">
                            <form action="consumerGrand" method="post" target="_self">
                                                             等级：<input type="text" name="cg_name" value="${consumergrand.cg_name }" >
