                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="emp_tel" name="emp_tel" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                         <font id="c_tel"></font>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="emp_email" name="emp_email" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="emp_age" name="emp_age" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                        <font id="e_age"></font>
                                    </div>
                                </div>
                    ...
                    <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" id="inlineRadio1" value="1" name="emp_sex" checked="">
                                    <label for="inlineRadio1"> 男 </label>
                                </div>
                                <div class="radio radio-inline">
                                    <input type="radio" id="inlineRadio2" value="0" name="emp_sex">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="emp_card" name="emp_card" class="form-control" type="text" placeholder="请输入身份证号码">
                                    <font id="e_card"></font>
                                </div>
                            </div>
                            <div class="form-group">
