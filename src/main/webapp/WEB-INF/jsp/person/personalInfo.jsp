        ...
        $.post(
            ...
            function(data) {
                for(var pro in data){
                    ...
                    if(${employee.fk_pro_id}!=null&&${employee.fk_pro_id}!=''){
                        if(${employee.fk_pro_id}==data[pro].provinceID){
            ...
            $.post(
                ...
                function(data) {
                    for(var city in data){
                        ...
                        if(${employee.fk_city_id}==data[city].cityID){
            ...
            $.post(
                    ...
                    function(data) {
                        for(var country in data){
                            ...
                            if(${employee.fk_country_id}==data[country].areaID){
...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <form target="_self" method="post" action="personalUpdate.action" class="form-horizontal m-t" id="signupForm" enctype="multipart/form-data" onsubmit="return confirmInfo()">
                <input name="emp_id" type="hidden" value="${employee.emp_id }">
            <div class="col-sm-6">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="emp_name" name="emp_name" value="${employee.emp_name }" class="form-control" type="text">
                                        <font id="c_name"></font>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="account" name="account" value="${employee.account }" class="form-control" type="text">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="emp_tel" name="emp_tel" value="${employee.emp_tel }" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                         <font id="c_tel"></font>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="emp_email" name="emp_email" value="${employee.emp_email }" class="form-control" type="text" aria-required="true" aria-invalid="true" class="error">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input id="emp_age" name="emp_age" class="form-control" value="${employee.emp_age }" type="text" aria-required="true" aria-invalid="true" class="error">
                                        <font id="e_age"></font>
                                    </div>
                                </div>
                    ...
                    <div class="ibox-content">
                            ...
                            <div class="form-group">
                                ...
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" id="inlineRadio1" value="1" name="emp_sex" <c:if test="${employee.emp_sex eq 1 }">checked="checked"</c:if>>
                                    <label for="inlineRadio1"> 男 </label>
                                </div>
                                <div class="radio radio-inline">
                                    <input type="radio" id="inlineRadio2" value="0" name="emp_sex" <c:if test="${employee.emp_sex eq 0 }">checked="checked"</c:if>>
                                ...
                                <div class="col-sm-8">
                                     <select data-placeholder="选择用户部门..." id="fk_dep_id" name="fk_dep_id" class="form-control" tabindex="2">
                                        ...
                                        <c:forEach items="${depList }" var="dep">
                                            <option value="${dep.dep_id }" <c:if test="${dep.dep_id eq employee.fk_dep_id}">selected="selected"</c:if>>${dep.dep_name }</option>
                                        </c:forEach>
                                    </select>
                                    <font id="dep_id"></font>
                                </div>
                                ...
                                <div class="col-sm-8">
                                     <select data-placeholder="选择用户学历..." id="fk_edu_id" name="fk_edu_id" class="form-control" tabindex="2">
                                        ...
                                        <c:forEach items="${eduList }" var="edu">
                                            <option value="${edu.edu_id }" <c:if test="${edu.edu_id eq employee.fk_edu_id}">selected="selected"</c:if>>${edu.edu_name }</option>
                                        </c:forEach>
                                    </select>
                                    <font id="edu_id"></font>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="emp_card" name="emp_card" value="${employee.emp_card }" class="form-control" type="text" placeholder="请输入身份证号码">
                                    <font id="e_card"></font>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                     <select data-placeholder="选择客户等级..." id="fk_role_id" name="fk_role_id" class="form-control" tabindex="2">
                                        ...
                                        <c:forEach items="${roleEmpList }" var="role">
                                            <option value="${role.role_id }" <c:if test="${role.role_id eq employee.fk_role_id}">selected="selected"</c:if>>${role.role_name }</option>
                                        </c:forEach>
                                    </select>
                                    <font id="r_id"></font>
                                </div>
